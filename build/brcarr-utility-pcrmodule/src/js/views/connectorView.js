var define, console;
define(['jquery', 'framework-core', 'framework-controls', '../models/tableCollection', 'template!../../content/connectorTemplate.html', './headerView', './searchToolbarView', './searchResultsView', 'logger', 'psw-framework-application-context', 'psw-framework-notifications'], function ($, Core, Controls, TableCollection, ConnectorTemplate, HeaderView, SearchToolbarView, SearchResultsView, Logger, ApplicationContext, Notifications) {
    'use strict';
